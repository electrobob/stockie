...
void nrf24l01_printinfo() {
	...
	sprintf(buff,"CONFIG: %02X\r\n", nrf24l01_readregister(NRF24L01_REG_CONFIG)); send_string(buff);
	sprintf(buff,"EN_AA: %02X\r\n", nrf24l01_readregister(NRF24L01_REG_EN_AA)); send_string(buff);
	sprintf(buff,"EN_RXADDR: %02X\r\n", nrf24l01_readregister(NRF24L01_REG_EN_RXADDR)); send_string(buff);
	sprintf(buff,"SETUP_AW: %02X\r\n", nrf24l01_readregister(NRF24L01_REG_SETUP_AW)); send_string(buff);
	sprintf(buff,"SETUP_RETR: %02X\r\n", nrf24l01_readregister(NRF24L01_REG_SETUP_RETR)); send_string(buff);
	sprintf(buff,"RF_CH: %02X\r\n", nrf24l01_readregister(NRF24L01_REG_RF_CH)); send_string(buff);
	sprintf(buff,"RF_SETUP: %02X\r\n", nrf24l01_readregister(NRF24L01_REG_RF_SETUP)); send_string(buff);
	sprintf(buff,"STATUS: %02X\r\n", nrf24l01_getstatus()); send_string(buff);
	sprintf(buff,"RX_ADR_P0_1B: %02X\r\n", nrf24l01_readregister(NRF24L01_REG_RX_ADDR_P0)); send_string(buff);
	sprintf(buff,"TX_ADR_1B: %02X\r\n", nrf24l01_readregister(NRF24L01_REG_TX_ADDR)); send_string(buff);

	
	sprintf(buff,"OBSERVE_TX: %02X\r\n", nrf24l01_readregister(NRF24L01_REG_OBSERVE_TX)); send_string(buff);
...
void nrf24l01_init() {
    ...
    _delay_ms(50); //wait for the radio to init
